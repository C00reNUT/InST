...
def test(args):
    ...
    if args.source_mask_path:
        ...
        source_mask_paths = sorted([f for f in source_mask_dir.glob('*.jpg')] + [f for f in source_mask_dir.glob('*.png')])
    else:
    ...
    if args.target_mask_path:
        ...
        target_mask_paths = sorted([f for f in target_mask_dir.glob('*.jpg')] + [f for f in target_mask_dir.glob('*.png')])
    else:
